 ...
 * @constructor
 */
function RpcBuilder(packer, peerID, transport)
{
  if(!packer)
  ...
  if(peerID instanceof Function || peerID && peerID.send instanceof Function)
  {
    if(transport)
  ...
  this.decode = function(message, transport)
  {
    ...
    if(method)
    {
      ...
      if(request && (dest == undefined || dest == self.peerID))
      {
